      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="text-sm text-muted leading-relaxed max-w-xs">
              ...
              our love for visual storytelling.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a
                href="https://www.youtube.com/@PersisPhotography"
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-full border border-border text-muted hover:border-accent hover:text-accent transition-all duration-300"
                aria-label="YouTube"
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted">
            &copy; {new Date().getFullYear()} PERSIS Photography. All rights
            reserved.
          </p>
          <p className="text-sm text-muted">
            Made with passion for the art of photography.
          </p>
        </div>
      </div>
    </footer>
